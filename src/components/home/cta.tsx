  ...
  return (
    <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-20 sm:pb-24">
      <div className="relative overflow-hidden rounded-3xl border border-border bg-surface p-10 sm:p-14 text-center">
        <div className="absolute -top-20 left-1/2 -translate-x-1/2 h-64 w-[36rem] bg-gradient-brand opacity-20 blur-3xl -z-0" />
        <div className="relative z-10">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/catalog"
              className="inline-flex items-center gap-2 h-11 px-6 rounded-xl bg-gradient-brand text-white font-semibold hover:brightness-110 transition-all"
            >
